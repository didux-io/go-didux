...
By far the most common scenario is people wanting to simply interact with the Didux Proof of Resource and Time (SPoRT) network:
 ...
 * Instead of using the default data directory (`~/.didux` on Linux for example), Geth will nest
...
As a developer, sooner rather than later you'll want to start interacting with Geth and the Didux
