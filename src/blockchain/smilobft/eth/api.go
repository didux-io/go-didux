...
func NewPublicEthereumAPI(e *Smilo) *PublicEthereumAPI {
...
func NewPublicMinerAPI(e *Smilo) *PublicMinerAPI {
...
func NewPrivateMinerAPI(e *Smilo) *PrivateMinerAPI {
...
// admin methods of the Smilo service.
func NewPrivateAdminAPI(eth *Smilo) *PrivateAdminAPI {
...
// PublicDebugAPI is the collection of Smilo full node APIs exposed
...
// related public debug methods of the Smilo service.
func NewPublicDebugAPI(eth *Smilo) *PublicDebugAPI {
...
// private debug methods of the Smilo service.
func NewPrivateDebugAPI(config *params.ChainConfig, eth *Smilo) *PrivateDebugAPI {
...
func (api *PrivateDebugAPI) AccountRange(ctx context.Context, start *common.Hash, maxResults int) (AccountRangeResult, error) {
	...
	if len(block.Transactions()) == 0 {
		...
		_, _, statedb, _, err = api.computeTxEnv(block.Hash(), len(block.Transactions())-1, 0)
		if err != nil {
			return AccountRangeResult{}, err
		}
	}
