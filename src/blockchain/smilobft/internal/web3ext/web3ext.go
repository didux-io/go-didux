...
web3._extend({
	...
	methods: [
		...
		new web3._extend.Method({
			name: 'sendRawTransactionVault',
			call: 'eth_sendRawTransactionVault',
			params: 2,
			inputFormatter: [null, null]
		}),
		new web3._extend.Method({
...
web3._extend({
	...
	[
		new web3._extend.Method({
			name: 'getSnapshot',
			call: 'smilobft_getSnapshot',
			params: 1,
			inputFormatter: [null]
		}),
		new web3._extend.Method({
			name: 'getSnapshotAtHash',
			call: 'smilobft_getSnapshotAtHash',
			params: 1
		}),
		new web3._extend.Method({
			name: 'getFullnodes',
			call: 'smilobft_getFullnodes',
			params: 1,
			inputFormatter: [null]
		}),
		new web3._extend.Method({
			name: 'getFullnodesByHash',
			call: 'smilobft_getFullnodesByHash',
			params: 1
		}),
		new web3._extend.Method({
			name: 'propose',
			call: 'smilobft_propose',
			params: 2
		}),
		new web3._extend.Method({
			name: 'discard',
			call: 'smilobft_discard',
			params: 1
		})
	],
	properties:
