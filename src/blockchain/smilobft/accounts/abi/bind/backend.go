...
type ContractTransactor interface {
	...
	EstimateGas(ctx context.Context, call core.CallMsg) (gas uint64, err error)
...
type ContractFilterer interface {
	...
	SubscribeFilterLogs(ctx context.Context, query core.FilterQuery, ch chan<- types.Log) (core.Subscription, error)
}
