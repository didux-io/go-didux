...
import (
	...
	"go-didux/src/blockchain/smilobft/eth/filters"
...
func (b *SimulatedBackend) CallContract(ctx context.Context, call smilobft.CallMsg, blockNumber *big.Int) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) PendingCallContract(ctx context.Context, call smilobft.CallMsg) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) EstimateGas(ctx context.Context, call smilobft.CallMsg) (uint64, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) FilterLogs(ctx context.Context, query smilobft.FilterQuery) ([]types.Log, error) {
...
func (b *SimulatedBackend) SubscribeFilterLogs(ctx context.Context, query smilobft.FilterQuery, ch chan<- types.Log) (smilobft.Subscription, error) {
