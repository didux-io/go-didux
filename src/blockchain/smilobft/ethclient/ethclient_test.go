...
var (
	_ = smilobft.ChainReader(&Client{})
	_ = smilobft.TransactionReader(&Client{})
	_ = smilobft.ChainStateReader(&Client{})
	_ = smilobft.ChainSyncReader(&Client{})
	_ = smilobft.ContractCaller(&Client{})
	_ = smilobft.GasEstimator(&Client{})
	_ = smilobft.GasPricer(&Client{})
	_ = smilobft.LogFilterer(&Client{})
	_ = smilobft.PendingStateReader(&Client{})
	// _ = ethereum.PendingStateEventer(&Client{})
	_ = smilobft.PendingContractCaller(&Client{})
)
...
func TestToFilterArg(t *testing.T) {
	...
	for _, testCase := range []struct {
		name   string
		input  smilobft.FilterQuery
		output interface{}
		err    error
	}{
		{
			"without BlockHash",
			smilobft.FilterQuery{
				Addresses: addresses,
