...
type Service struct {
	...
	eth    *eth.Smilo         // Full Ethereum service if monitoring a full node
...
func New(url string, ethServ *eth.Smilo, lesServ *les.LightEthereum) (*Service, error) {
...
func (s *Service) login(conn *websocket.Conn) error {
	...
	//must pass engine protocol name for Smilo
	p := s.engine.Protocol()
